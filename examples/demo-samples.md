...
- Current demo report: [benign.json](./reports/benign.json)
- Current observed outcome: `allow`

## `high-risk`

- Purpose: show baseline hard-trigger behavior
- Current demo report: [high-risk.json](./reports/high-risk.json)
- Current observed outcome: `block`

## `install-risk`

- Purpose: show install-chain extraction and origin-integrity findings
- Current demo report: [install-risk.json](./reports/install-risk.json)
...
- Current demo report: [prompt-risk.json](./reports/prompt-risk.json)
...
- Current demo report: [precedence-shadowing.json](./reports/precedence-shadowing.json)
...
- Current demo report: [runtime-refinement.json](./reports/runtime-refinement.json)
...
- Current demo report: [suppression-audit.json](./reports/suppression-audit.json)
